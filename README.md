...
| Final Demo | -Refine precision of the motor movements                                                                                                                 | Both                                                         |
...
On the practical side, we encountered a few issues in attaching a spike structure to the bottom of the solenoids and positioning them closer so that they would resemble a normal braille size. At the end, we were able to superglue pointy structures to the solensoids to punctuate the bottom of the paper, although the light pressure didn't allow us to see the correct pattern on paper.
